...
App.Main = (function() {'use strict';
	...
	var bindEvents = function() {
		...
		$("#btnConvert").on("click", function() {
			...
			var inputF = $("#inputFahrenheit").val();
			$("#pCeliusResult").html(converter.fahrenheitToCelius(inputF) +" Celsius");

			var inputMiles = $("#inputMiles").val();
			$("#pKmResult").html(converter.milesToKilometers(inputMiles) +" Km");

			var inputNumToRoot = $("#inputValueForRoot").val();
			$("#pSQRTResult").html(converter.squareRoot(inputNumToRoot));
		});
	};
